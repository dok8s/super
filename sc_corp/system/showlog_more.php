...
echo "<table id='glist_table' border='0' cellspacing='1' cellpadding='0'  bgcolor='006255' class='m_tab' width='778'>
		...
		<td width='126'>最后活动时间</td>
		<td width='390'>操作</td>
		<td width='173'>登陆IP</td>
		</tr>";

$webtable = array('web_super','web_corprator','web_world','web_agents');
if(isset($webtable[$level])){
	$query = mysql_query("select agname from {$webtable[$level]} where super='$super' and agname='$user'");
