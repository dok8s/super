...
<!--                            </div>-->
                    ...
                    <div class="navbox">
                        <div class="nav">
                            ...
                            <li class="drop-menu-effect"> <a onClick="go_web(1,1,'/sc_corp/corprator/super_corprator.php?uid=<?=$uid?>');" target="main" onMouseOver="window.status='帐号管理'; return true;" onMouseOut="window.status='';return true;"><span>帐号管理</span></a>
                            </li>

                            <li class="drop-menu-effect"> <a href="/sc_corp/report/report.php?uid=<?=$uid?>"
                                                             target="main" onMouseOver="window.status='报表'; return true;" onMouseOut="window.status='';return true;"><span>报表</span></a>
                            </li>
                            <li class="drop-menu-effect"> <a href="/sc_corp/other_set/show_currency.php?uid=<?=$uid?>"
