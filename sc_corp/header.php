...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td class="top_color">登入0--<?=$agname?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;session:<?=$_SESSION["tktk"]?>
	...
	<div class="rig">
                    ...
                    | <a href="/sc_corp/logout.php?uid=<?=$uid?>" target="_top" onMouseOver="window.status='登出'; return true;" onMouseOut="window.status='';return true;">登出</a>
      </div>
	</td>
  </tr>
  <tr>
	...
	<a onClick="go_web(1,1,'/sc_corp/corprator/super_corprator.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">股东</a>
	<a onClick="go_web(1,1,'/sc_corp/super_agent/body_super_agents.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">总代理</a>
	<a onClick="go_web(1,2,'/sc_corp/agents/su_agents.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">代理</a>
	<a onClick="go_web(1,3,'/sc_corp/members/ag_members.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">会员</a>
	<a onClick="go_web(1,4,'/sc_corp/su_subuser.php?uid=<?=$uid?>');" style="cursor:hand;"><img src="/images/control/tri.gif">子帐号</a>
	<? if($setdata['d0_wager_add']==1){ ?>
	<a onClick="go_web(1,6,'/sc_corp/wager_list/wager_add.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">添单帐号</a>
	<? } ?>
	<? if($setdata['d0_wager_hide']==1){ ?>
	<a onClick="go_web(1,7,'/sc_corp/wager_list/wager_hide.php?uid=<?=$uid?>');" style="cursor:hand"><img src="/images/control/tri.gif">隐单帐号</a>
	<? } ?>
	
	</nobr></td<?=$CFLAG_E?>>
	<<?=$CFLAG_S?>td nowrap class="coolButton" onClick="show_webs('rp');">&nbsp;<nobr>[注单管理]</nobr>&nbsp;</td>
	<td id=rp_list style="color: blue;"><nobr>
	...
	<<?=$RFLAG_S?>td nowrap><a href="/sc_corp/report/report.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='报表'; return true;" onMouseOut="window.status='';return true;">&nbsp;[报表]</a></td<?=$RFLAG_E?>>
	<td nowrap><a href="/sc_corp/other_set/show_currency.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='币值'; return true;" onMouseOut="window.status='';return true;">&nbsp;[币值]</a></td>
	<td nowrap><a href="/sc_corp/other_set/show_result.php?uid=<?=$uid?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='赛果'; return true;" onMouseOut="window.status='';return true;">&nbsp;[赛果]</a></td<?=$OFLAG_E?>>
	...
	<td nowrap><a href="/sc_corp/body_home.php?uid=<?=$uid?>&langx=<?=$langx?>" style="cursor:hand;color:#bb0000" target="main" onMouseOver="window.status='公告'; return true;" onMouseOut="window.status='';return true;">&nbsp;[公告]</a></td>
	</tr>
	</table>
    </td>
  </tr>
