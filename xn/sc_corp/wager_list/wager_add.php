...
echo "              </select>\r\n            </td>\r\n            <td> / ";
echo $page_count;
echo " Trang -- </td>\r\n            <td>\r\n              <input type=BUTTON name=\"append\" value=\"Thêm\" onClick=\"document.location='./mem_add.php?uid=";
echo $uid;
