...
$sql = "select Agname,ID from web_super where Oid='$uid'";
...
$sql="select mb_team_tw,tg_team_tw,m_date,lower(substring(DATE_FORMAT(m_start,'%h:%i%p'),1,6)) as m_time,mb_mid,tg_mid,m_league_tw,mb_inball,tg_inball";
                        ...
                        foreach ($items as $leage => $rows) {
                            ...
                            <tr class="bet_leagueNO_hand" style="display:*DISPLAY*;">
                                ...
                                if($gtype=='FT' || $gtype=='BS'){
                                    ?>
                                    <td width="20%" class="TDcenter">Giờ nghỉ</td>
                                    <td width="20%" class="TDcenter">Khán giả</td>
                                    <?
                                } else {
                                    ?>
                            ...
                            <?
                            foreach ($rows as  $row) {
                                if (count(explode("PK", $row['m_league'])) == 1 && count(explode("Chậm trễ", $row['m_league'])) == 1) {
                                    ?>
                                    <!----------close TR-------------->
