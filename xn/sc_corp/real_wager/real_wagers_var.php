...
case 'OU':
	...
	$sql="SELECT m_league as m_league FROM `foot_match` WHERE r_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by gid";
	break;
case 'HOU':
	$mysql="SELECT * FROM `foot_match` WHERE mid%2=0 and r_show=2 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league as m_league FROM `foot_match` WHERE r_show=2 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by gid";
	break;
case 'RE':
	$mysql="SELECT * FROM `foot_match` WHERE re_show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league as m_league FROM `foot_match` WHERE re_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by gid";
	break;
case 'PD':
	$mysql="SELECT * FROM `foot_match` WHERE pd_show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league as m_league FROM `foot_match` WHERE pd_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by gid";
	break;
case 'HPD':
	$mysql="SELECT * FROM `foot_match` WHERE mid%2=0 and pd_show=2 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league as m_league FROM `foot_match` WHERE pd_show=2 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by gid";
	break;
case 'F':
	$mysql="SELECT * FROM `foot_match` WHERE f_show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league as m_league FROM `foot_match` WHERE f_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by gid";
	break;
case 'T':
	$mysql="SELECT * FROM `foot_match` WHERE t_show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league as m_league FROM `foot_match` WHERE t_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by gid";
	break;
case 'P':
	$mysql="SELECT * FROM `foot_match` WHERE p_show=1 and `m_start` > now( ) and `m_Date` ='$mDate'";
	$sql="SELECT m_league as m_league FROM `foot_match` WHERE p_show=1 and `m_start` > now( ) and `m_Date` ='$mDate' group by m_league order by gid";
	break;
case 'PL':
...
switch ($rtype){
case "OU":
	$sql1 = "select mid,concat(M_Date,'<br>',M_Time,if(m_type=0,'','<br><font style=background-color=red>走地</font>')) as pdate,$mb_team as MB_Team,$tg_team as TG_Team,m_letb as M_LetB_en,m_league as league,MB_Win,TG_Win,M_Flat,MB_Dime_Rate,TG_Dime_Rate,if(m_dime='','',concat('o',m_dime)) as MB_Dime_en,MB_LetB_Rate,TG_LetB_Rate,MB_MID,TG_MID,ShowType,M_Type,R_Show from foot_match where r_show=1 and `m_Date` ='$mDate' and `m_start` > now( ) ".$sleague."  order by display,mid limit $offset,40";
...
case "HOU":
	...
	$sql1 = "select mid,concat(M_Date,'<br>',M_Time,if(m_type=0,'','<br><font style=background-color=red>走地</font>')) as pdate,$mb_team as MB_Team,$tg_team as TG_Team,m_letb as M_LetB_en,m_league as league,MB_Win,TG_Win,M_Flat,MB_Dime_Rate,TG_Dime_Rate,if(m_dime='','',concat('o',m_dime)) as MB_Dime_en,MB_LetB_Rate,TG_LetB_Rate,MB_MID,TG_MID,ShowType,M_Type,R_Show from foot_match where r_show=2 and mid%2=0 and `m_Date` ='$mDate' and `m_start` > now( ) ".$sleague."  order by display,mid limit $offset,40";
...
case "RE":
	...
	break;
case "PD":
	$sql1 = "select mid,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,m_league as league,ShowType,if(PD_Show=1,'Y','N') as pd_show from foot_match where pd_show=1 and mid%2=1 and `m_start` > now( ) AND `m_Date` ='$mDate' ".$sleague." order by m_start,mid limit $offset,40";
	...
	break;
case "HPD":
	$sql1 = "select mid,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,m_league as league,ShowType,if(PD_Show=2,'Y','N') as pd_show from foot_match where pd_show=2 and mid%2=0 and `m_start` > now( ) AND `m_Date` ='$mDate' ".$sleague." order by m_start,mid limit $offset,40";
	...
	break;
case "EO":
	$sql1 = "select if(t_show=1,'Y','N') as t_show,mid,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,m_league as M_Sleague,S_Single,S_Double,S_0_1,S_2_3,S_4_6,S_7UP,MB_MID,TG_MID,ShowType from foot_match where`m_start` > now( ) AND `m_Date` ='$mDate' and t_show=1 ".$sleague." order by m_start,mid limit $offset,40";
...
case "F":
	$sql1 = "select mid,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,m_league as league,MBMB,MBFT,MBTG,FTMB,FTFT,FTTG,TGMB,TGFT,TGTG,MB_MID,TG_MID,ShowType,if(f_Show=1,'Y','N') as f_show from foot_match where f_show=1 and `m_start` > now( ) AND `m_Date` ='$mDate' ".$sleague." order by m_start,mid limit $offset,40";
	...
	break;
case "P":
	$sql1 = "select MID,M_Date,M_Time,$mb_team as MB_Team,$tg_team as TG_Team,m_league as M_Sleague,MB_MID,TG_MID,ShowType from foot_match where `m_start` > now( ) AND `m_Date` ='$mDate'".$league." and R_Show=1 order by m_start,mid";
	//$sql1 = "select mid,concat(M_Date,'<br>',M_Time,if(m_type=0,'','<br><font style=background-color=red>走地</font>')) as pdate,$mb_team as MB_Team,$tg_team as TG_Team,m_letb as M_LetB_en,m_league as league,MB_Win,TG_Win,M_Flat,MB_Dime_Rate,TG_Dime_Rate,if(m_dime='','',concat('o',m_dime)) as MB_Dime_en,MB_LetB_Rate,TG_LetB_Rate,MB_MID,TG_MID,ShowType,M_Type,R_Show from foot_match where r_show=1 and `m_Date` ='$mDate' and `m_start` > now( ) ".$sleague."  order by display,mid limit $offset,40";
