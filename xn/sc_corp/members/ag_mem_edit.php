...
if ($keys=='upd'){
	...
	if ($row['pay_type']==1){
		...
		$mysql="insert into  agents_log (M_DateTime,M_czz,M_xm,M_user,M_jc,Status) values('".date("Y-m-d H:i:s")."','$agname','Thay đổi mật khẩu','$_REQUEST[username]','Thành viên',2)";
