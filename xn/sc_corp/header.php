                ...
                <div name="MaxTag" id="header" src="/js/header.js" linkage="header">
                        ...
                        <div id="header_tr" name="fixHead" class="top_option_contain">
                            <div id="header_td" class="lang_contain" style="width:166px;">
                                <div id="lang_btn" class="lang_btn">
                                    <span id="sel_langx" name="sel_langx" class="lang_txt">登入0-<?=$agname?></span>
                                </div>
                            </div>
                            <? if($setdata['d0_ag_online_show']==1){ ?>
                                <div id="online_mem" class="online_btn" title=""><a href='system/syslog.php?uid=<?=$uid?>' target="main"><span style='color:#1e1e1e'>Đại lý trực tuyến</span></a></div>
                                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                            <? } ?>
                            <? if($setdata['d0_mem_online_show']==1){ ?>
                                <div id="online_mem" class="online_btn" title=""><a href="system/memlog.php?uid=<?=$uid?>" target="main"><span style='color:#1e1e1e'>Thành viên trực tuyến</span></a></div>
                            <? } ?>
                            <div id="new_url" class="contact_us">[
                                <a style="color:#b8a6a6;" href="/xn/sc_corp/logout.php?uid=<?=$uid?>" target="_top" onMouseOver="window.status='Đăng xuất'; return true;" onMouseOut="window.status='';return true;">Đăng xuất</a>
                                ]
                            </div>
                            <div id="contactus" class="contact_us" onclick="notice();">Liên lạc với...</div>
                            <div id="live_chat" class="live_chat" style="width: 52px;" onclick="notice();">Dịch vụ khách...</div>
                            <div id="live_chat" class="live_chat" style="width: 52px;" onclick="Go_Chg_pass(2);">Thay đổi mật khẩu</div>
                    ...
                    <div class="navbox">
                        <div class="nav">
                            ...
                            <li class="drop-menu-effect"><a href="/xn/sc_corp/body_home.php?uid=<?=$uid?>&langx=<?=$langx?>"
                                                            target="main" onMouseOver="window.status='Trang chủ'; return true;" onMouseOut="window.status='';return true;">
                                    <span>Trang chủ</span></a>
                            </li>
                            <li class="drop-menu-effect"><a href="/xn/sc_corp/announcement/get_an.php?uid=<?=$uid?>" target="main" onMouseOver="window.status='Nội dung thông báo'; return true;" onMouseOut="window.status='';return true;"><span>Nội dung thông báo</span></a>
                            </li>

                            <li class="drop-menu-effect"> <a href="/xn/sc_corp/other_set/show_result.php?uid=<?=$uid?>"
                                                             target="main" onMouseOver="window.status='Kết quả'; return true;" onMouseOut="window.status='';return true;"><span>Kết quả</span></a>
                            </li>
                            <li class="drop-menu-effect"> <a onClick="go_web(1,1,'/xn/sc_corp/corprator/super_corprator.php?uid=<?=$uid?>');" target="main" onMouseOver="window.status='Quản lý tài khoản'; return true;" onMouseOut="window.status='';return true;"><span>Quản lý tài khoản</span></a>
                            </li>

                            <li class="drop-menu-effect"> <a href="/xn/sc_corp/report/report.php?uid=<?=$uid?>"
                                                             target="main" onMouseOver="window.status='Báo cáo'; return true;" onMouseOut="window.status='';return true;"><span>Báo cáo</span></a>
                            </li>
                            <li class="drop-menu-effect"> <a href="/xn/sc_corp/other_set/show_currency.php?uid=<?=$uid?>"
                                                             target="main" onMouseOver="window.status='Tiền tệ'; return true;" onMouseOut="window.status='';return true;"><span>Tiền tệ</span></a>
                            </li>
<!--                            <li class="drop-menu-effect"> <a href="./scroll_history.php?uid=--><?//=$uid?><!--&langx=--><?//=$langx?><!--&scoll_set=scoll_set3','','help:no')"-->
