...
if ($keys=='add'){
	...
	$mysql="insert into  agents_log (M_DateTime,M_czz,M_xm,M_user,M_jc,Status) values('".date("Y-m-d H:i:s")."','$agname1','Thêm','$memname','Cổ đông',2)";
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
	<tr>
		...
		$credit_canuse = $credit-$credit_used;
			echo "<BR><font color=#FF0000> $agname </font>Giới hạn / lời nhắc giới hạn tín dụng:$credit Đã sử dụng:$credit_used  Có sẵn:$credit_canuse";
			}
		?>
		</td>
	</tr>
    ...
    <tr class="m_bc_ed">
      <td class="m_suag_ed" width="120">Cổ đông:</td>
      <td>
