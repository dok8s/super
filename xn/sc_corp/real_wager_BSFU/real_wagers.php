	...
	<div class="t_div" id="line_window" style="visibility:hidden;position: absolute;">
		...
		<table id="gdiv_table" border="0" cellspacing="1" cellpadding="0" bgcolor="#006255" class="m_tab" width="544">
			<tr class="m_title_ft">
                ...
                <td nowrap> Một nửa táo bạo </td>
                <td nowrap> Đơn và đôi </td>
                <td nowrap> Tổng số mục tiêu </td>
                <td nowrap> Trường toàn bộ một nửa </td>
                <td nowrap> giải phóng mặt bằng </td>
                <td nowrap> Nửa bóng để làm bóng </td>
                <td nowrap> kích thước bóng bán thời gian </td>
                <td nowrap> Bóng một tay </td>
                <td nowrap> Nửa kích thước </td>
                <td nowrap> Chiến thắng một nửa </td>
			</tr>
		</table>
